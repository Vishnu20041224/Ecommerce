                            ...
                            {searchText.length >= 1 && <ul className='position-absolute p-0 top-20 start-0 searchUl'>
                                {searchTextincludesArr.map((data, i) => (
                                    <Link key={i} onClick={() => {
                                        ...
                                        <li className='p-1 border-bottom d-flex gap-1'>
                                            <img src={`${data.mainImg}`} alt={data.name} style={{ width: "25px", objectFit: "contain" }} />
                                            <span className='fs-sm-6 py-sm-1 d-block d-md-none'>{(data.ditails.length >25 ?data.ditails.substring(0, 25) + "...":data.ditails)}</span>
                                            <span className='fs-sm-6 py-sm-1 d-none d-md-block'>{(data.ditails.length >50 ?data.ditails.substring(0, 50) + "...":data.ditails)}</span>
                                        </li>
                                    </Link>
                                ))}
                            </ul>}
