                ...
                <Carousel className="" >
                    <Carousel.Item>
                        <Link to={`shirt`}>
                            <img
                                ...
                                src="https://images-eu.ssl-images-amazon.com/images/G/31/Symbol/2025/Jupiter/GW/Hero/Event/PC/1-2._CB799216726_.jpg"
                                alt="Shirt slide"
                            />
                        </Link>
                    </Carousel.Item>
                    ...
                    <Carousel.Item>
                        <Link to={`phone`}>
                            <img
                                className="d-block w-100"
                                src="https://images-eu.ssl-images-amazon.com/images/G/31/img23/Wireless/nbshagun/Jup25/GW/D304708860_IN_Jup25_Samsung_M16PC_PB_LIVE_Lifestyle_3000x1200._CB800955375_.jpg"
                                alt="Phone slide"
                            />
                        </Link>
                    </Carousel.Item>
                    ...
                    <Carousel.Item>
                        <Link to={`shoe`}>
                            <img
                                className="d-block w-100"
                                src="https://images-eu.ssl-images-amazon.com/images/G/31/2025/GW/Jupiter/ATF/Unrec/PC/2090537951._CB800972877_.jpg"
                                alt="Shoe slide"
                            />
                        </Link>
                    </Carousel.Item>
